                ...
                {availableThemes.map(theme => (
                  ...
                  >
                    ...
                    <div className={`w-5 h-5 rounded border flex items-center justify-center shrink-0 ${
                       filters.themes.includes(theme) ? 'bg-indigo-600 border-indigo-600' : 'border-slate-300 bg-white'
                    }`}>
                ...
                {availableBusinessGroups.map(bg => (
                  <label 
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                      filters.businessGroups.includes(bg) 
                        ? 'bg-blue-50 border-blue-200 shadow-sm' 
                        : 'bg-white border-slate-200 hover:bg-slate-50'
                    }`}
                  >
                    <div className={`w-5 h-5 rounded border flex items-center justify-center shrink-0 ${
                      filters.businessGroups.includes(bg) ? 'bg-blue-600 border-blue-600' : 'border-slate-300 bg-white'
                    }`}>
